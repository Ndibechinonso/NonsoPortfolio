    ...
    return (
        <div className='portfolioContainer' id='portfolio'>
            <div data-aos='fade-up'>
                ...
                <h4>Software Business Solutions Consulting (Sterling Bank PLC)</h4>
                <div className='job-title'><h5>Frontend Engineer</h5> <h6>12/2021 till date</h6></div>
                <h4>Quabbly</h4>
                <div className='job-title'><h5>Frontend Engineer</h5> <h6>07/2021 - 10/2021</h6></div>

                <h4>Stutern Graduate Accelerator</h4>
               <div className='job-title'><h5>Software Developer</h5><h6>01/2020 - 07/2021</h6></div>
               </div>
...
{/* 
            ...
            <div className='cardRow'>
                <Card anim='zoom-in-up' tasks={STACKS} link="fas fa-user-group" header='PTEN' text="PTEN is a full stack app I am currently building for a client in the UK" language='Tech Stack' languages='ReactJs, React-Redux, ExpressJs, MongoDB' />
            </div>
