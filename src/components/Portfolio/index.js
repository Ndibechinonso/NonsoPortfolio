...
export default function Portfolio(props) {
    ...
    return (
        <div className='portfolioContainer' id='portfolio'>
            ...
            <div data-aos='fade-up'><h3>Projects</h3><p>A couple of projects that I've built in the past. I'm learning a ton right now, so you can expect more to appear soon!
</p>
            </div>
