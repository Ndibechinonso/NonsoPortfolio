    ...
    return (
        <div className='navbarContainer' id='navbar'>
            <div className='navbar'>
                ...
                <div className='links'>
                   <div className='deskop-links'><div className='about'><a href='#intro'>HOME</a></div> <div className='about'><a href='#anime'>ABOUT</a></div> <div className='portfolio'><a href='#portfolio'>PORTFOLIO</a></div><div className='contact'><a href='#footer'>CONTACT</a></div> </div>
